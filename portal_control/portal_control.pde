...
void setup() {
    ...
    // create channels
    chnl[0] = chnl_00 = new Channel("  chnl_00", journal[1]);
	//chnl[1] = greenArm = new Arm("green", greenLeft, greenRight, GREEN_OPACITY);
...
void printInstructions() {
	...
	println("                 Keyboard controls");
  	println("          -----------------------------------");
   	...
   	println("   'J'	  selects a new journal page as channel source");
   	println("   'E'	  selects a new emblem as channel source");
   	println("          -----------------------------------");
   	println("");
}
